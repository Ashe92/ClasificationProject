...
namespace LogAnalysisProject.Models
{
    public class LogAnalysis
    {
        ...
        public  List<KeyValuePair<string, int>> AverageNumberOfSessionForUser { get; set; }
        public List<KeyValuePair<Session, int>> NumberOfRequests{ get; set; }
        public List<KeyValuePair<Session, int>> SessionStartingHour{ get; set; }
